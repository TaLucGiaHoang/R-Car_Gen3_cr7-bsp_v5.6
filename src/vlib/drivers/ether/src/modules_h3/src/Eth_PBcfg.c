...
*******************************************************************************/
/*
 * V1.0.0:  08-Feb-2016  : Initial Version                                     *
 * V1.0.1   05-Aug-2016  : Replace ETH_59_, Eth_59_ by ETH_, Eth_              *
 * V1.1.0   14-Sep-2016  : Update Compiler Abstraction and Memory Mapping      *
 *                         follow Specification of AUTOSAR Release 4.2.2       *
 * V1.1.1   11-Jan-2017  : Remove EthByteOrder                                 *
 * V1.1.2   08-Mar-2017  : Remove EthBeTimeStampStore,                         *
 *                         EthStreamTimeStampStore                             *
 * V1.1.3   04-Apr-2017  : Remove parameter EthPromMode                        *
 * V1.2.0   04-May-2017  : Add new parameter EthMagicPacketNotification        *
 *                         Include new header file Eth_Cbk.h                   *
 * V1.2.1   17-Jul-2017  : Add new ucStartOfPayloadCrcArea field to            *
 *                         Eth_GstConfiguration structure                      *
 * V1.2.2   15-Jan-2018  : Update Memory Mapping of Global data               */
/******************************************************************************/

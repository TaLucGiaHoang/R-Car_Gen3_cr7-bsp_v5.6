 ...
 * V1.0.1:      30-Sep-2016: Add long long type
 */
...
**                      Version Information                                   **
*******************************************************************************/
/* AUTOSAR specification release version information for R4.2.2 */
#define PLATFORM_TYPES_AR_RELEASE_MAJOR_VERSION     4
#define PLATFORM_TYPES_AR_RELEASE_MINOR_VERSION     2
#define PLATFORM_TYPES_AR_RELEASE_REVISION_VERSION  2
...
typedef signed long long    sint64;         /*       -2^63 .. 2^63           */
typedef unsigned long long  uint64;         /*           0 .. 2^64 -1        */

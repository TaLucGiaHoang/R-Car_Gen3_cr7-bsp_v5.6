...
/**********************************************************************************************************************
 Macro definitions
 *********************************************************************************************************************/
#define IMRDRV_IMR_CHANNEL_NUM      (1U)    /* The number of IMR channel. */

/* Validity of Channel number for function r_imrdrv_devctl_check_ch() */
#define IMRDRV_DEV_CHANNEL_0_ISVALID  IMRDRV_ERROR_OK
#define IMRDRV_DEV_CHANNEL_1_ISVALID  IMRDRV_ERROR_PAR
#define IMRDRV_DEV_CHANNEL_2_ISVALID  IMRDRV_ERROR_PAR
#define IMRDRV_DEV_CHANNEL_3_ISVALID  IMRDRV_ERROR_PAR

...
#define EMMC_SD_STATUS_SIZE		64	/* SD_STATUS size */
...
#define EMMC_EXT_CSD_CARD_TYPE_HS200_18V		0x10
#define EMMC_EXT_CSD_CARD_TYPE_HS400_18V		0x40
...
#define EMMC_SWITCH_HS200_TIMING	(EXTCSD_ACCESS_BYTE | HS_TIMING_ADD |\
					 HS_TIMING_HS200)	/* H'03b90200 */
#define EMMC_SWITCH_HS400_TIMING	(EXTCSD_ACCESS_BYTE | HS_TIMING_ADD |\
					 HS_TIMING_HS400)	/* H'03b90300 */
...
#define TIMING_HS200			2UL
#define TIMING_HS400			3UL
...
/* Tuning */
#define EMMC_SDHI_MAX_TAP			3
#define EMMC_SDHI_TUNING_TIMEOUT	150
#define EMMC_SDHI_TUNING_RETRIES	40
#define EMMC_TUNING_NONE		0
#define EMMC_TUNING_DOING		1
#define EMMC_TUNING_DONE		2
#define EMMC_NEED_RETUNING		3
...
typedef struct {
	...
	int dma_tranend1;				/* DMA Transfer End interrupt */
	...
	/* SCC */
	uint8_t tuning_status;
    uint32_t tap;
    uint32_t tap_set;
    uint32_t tap_num;
    char taps[EMMC_SDHI_TUNING_RETRIES];
    char smpcmp[EMMC_SDHI_TUNING_RETRIES];

	/* HS400 Mode */
	uint8_t hs400_capable;
	int hs400_use_4tap;

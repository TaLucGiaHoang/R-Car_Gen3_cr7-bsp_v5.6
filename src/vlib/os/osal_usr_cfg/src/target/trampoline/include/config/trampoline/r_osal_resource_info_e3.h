...
*************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    r_osal_resource_info_e3.h
* Version :      1.0.0
* Product Name : OSAL
* Device(s) :    R-Car
* Description :  OSAL resource configuration file for E3
***********************************************************************************************************************/
#ifndef OSAL_USR_INFO_E3_H
#define OSAL_USR_INFO_E3_H
...
/*******************************************************************************************************************//**
 * @var gs_osal_interrupt_thread_config_e3
 * osal user configuration : interrupt thread configuration table
***********************************************************************************************************************/
st_osal_interrupt_config_t  gs_osal_interrupt_thread_config_e3[] =
{

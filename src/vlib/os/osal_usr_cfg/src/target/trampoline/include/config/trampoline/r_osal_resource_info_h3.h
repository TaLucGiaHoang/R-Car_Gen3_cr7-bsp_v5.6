...
*************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    r_osal_resource_info_h3.h
* Version :      1.0.0
* Product Name : OSAL
* Device(s) :    R-Car
* Description :  OSAL resource configuration file for H3
***********************************************************************************************************************/
#ifndef OSAL_USR_INFO_H3_H
#define OSAL_USR_INFO_H3_H
...
#include "config/trampoline/r_osal_resource_info.h"

/*******************************************************************************************************************//**
 * @var gs_osal_interrupt_thread_config_h3
 * osal user configuration : interrupt thread configuration table
***********************************************************************************************************************/
st_osal_interrupt_config_t  gs_osal_interrupt_thread_config_h3[] =
{
    ...
    {445, "vspi_01",                OSAL_INTERRUPT_PRIORITY_TYPE12},

    {.id = OSAL_INTERRUPT_INVALID_ID}
};

#endif /* OSAL_USR_INFO_H3_H */

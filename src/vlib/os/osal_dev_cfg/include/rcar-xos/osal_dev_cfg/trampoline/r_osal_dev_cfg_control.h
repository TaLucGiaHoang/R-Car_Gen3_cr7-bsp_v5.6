...
* Product Name : OSAL
* Device(s) :    R-Car
* Description :  OSAL device configuration
***********************************************************************************************************************/
...
typedef struct st_osal_device_control
{
    ...
    base_mutex_t                     inner_mtx;             /*!< Internal mutex object */
...
* @return           uint32_t  SoC type identifier
***********************************************************************************************************************/
uint32_t R_OSAL_DCFG_GetSocType(void);

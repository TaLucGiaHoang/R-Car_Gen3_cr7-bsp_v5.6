...
uint32_t R_OSAL_DCFG_GetSocType(void)
{
    ...
    switch (soc) {
        case R_PRR_RCARE3:
            return (uint32_t)OSAL_DEVICE_SOC_TYPE_E3;
        case R_PRR_RCARH3:
            return (uint32_t)OSAL_DEVICE_SOC_TYPE_H3;
        case R_PRR_RCARM3W:
            return (uint32_t)OSAL_DEVICE_SOC_TYPE_M3;
        case R_PRR_RCARM3N:
            return (uint32_t)OSAL_DEVICE_SOC_TYPE_M3N;
    }

    return (uint32_t)OSAL_DEVICE_SOC_TYPE_INVALID;
}

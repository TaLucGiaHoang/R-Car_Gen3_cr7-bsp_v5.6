...
*************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    r_osal_dev_cfg_tbl_h3.h
* Version :      1.0.0
* Product Name : OSAL
* Device(s) :    R-Car H3
...
***********************************************************************************************************************/
static st_osal_interrupt_info_t gs_int_vspd_h3[3][2] =
{
    {
        {466}, {162}
    },
...
/*******************************************************************************************************************//**
 * @var gs_osal_device_info_h3
 * osal device configuration : device information structure
***********************************************************************************************************************/
st_osal_device_info_t gs_osal_device_info_h3[] =
{
    ...
    /* VSPD */
    {"vspd_00",               "vspd",              0xFEA20000U, 0x00008000U, gs_int_vspd_h3[0],       2U, R_PMA_HWA_ID_VSPD0,         OSAL_PM_POLICY_CG,       "invalid"},
    {"vspd_01",               "vspd",              0xFEA28000U, 0x00008000U, gs_int_vspd_h3[1],       2U, R_PMA_HWA_ID_VSPD1,         OSAL_PM_POLICY_CG,       "invalid"},
    {"vspd_02",               "vspd",              0xFEA30000U, 0x00008000U, gs_int_vspd_h3[2],       2U, R_PMA_HWA_ID_VSPD2,         OSAL_PM_POLICY_CG,       "invalid"},
    ...
    /* MFIS */
    {"mfis_00",               "mfis",              0xE6260000U, 0x00001000U, gs_int_mfis[0],          1U, 0xFFFFU,                    OSAL_PM_POLICY_CG,       "invalid"},
    ...
    {"vspi_01",               "vspi",              0xFE9B0000U, 0x00008000U, gs_int_vspi[1],          1U, R_PMA_HWA_ID_INVALID,       OSAL_PM_POLICY_CG,       "invalid"},

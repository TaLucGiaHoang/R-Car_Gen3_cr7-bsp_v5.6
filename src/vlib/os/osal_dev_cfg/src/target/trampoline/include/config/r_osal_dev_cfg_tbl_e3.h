...
*************************************************************************************************************/
/***********************************************************************************************************************
* File Name :    r_osal_dev_cfg_e3.h
* Version :      1.0.0
* Product Name : OSAL
* Device(s) :    R-Car E3
* Description :  OSAL device configuration file for R-Car E3
***********************************************************************************************************************/
#ifndef OSAL_DEV_CFG_E3_H
#define OSAL_DEV_CFG_E3_H
...
***********************************************************************************************************************/
static st_osal_interrupt_info_t gs_int_vspd_e3[3][2] =
{
    {
        {466}, {162}
    },
...
/*******************************************************************************************************************//**
 * @var gs_osal_device_info_e3
 * osal device configuration : device information structure
***********************************************************************************************************************/
st_osal_device_info_t gs_osal_device_info_e3[] =
{
    ...
    /* VSPD */
    {"vspd_00",               "vspd",              0xFEA20000U, 0x00008000U, gs_int_vspd_e3[0],       2U, R_PMA_HWA_ID_VSPD0,         OSAL_PM_POLICY_CG,       "invalid"},
    {"vspd_01",               "vspd",              0xFEA28000U, 0x00008000U, gs_int_vspd_e3[1],       2U, R_PMA_HWA_ID_VSPD1,         OSAL_PM_POLICY_CG,       "invalid"},
    {"vspd_02",               "vspd",              0xFEA30000U, 0x00008000U, gs_int_vspd_e3[2],       2U, R_PMA_HWA_ID_VSPD2,         OSAL_PM_POLICY_CG,       "invalid"},

...
osal_autosar_thread_t osal_autosar_thread_table[] = {
    ...
    { &high1, &task_high1_sleep_alarm, 14, "", NULL, NULL, NULL, NULL },
    { &high2, &task_high2_sleep_alarm, 14, "", NULL, NULL, NULL, NULL },
    { &high3, &task_high3_sleep_alarm, 13, "", NULL, NULL, NULL, NULL },
    { &high4, &task_high4_sleep_alarm, 13, "", NULL, NULL, NULL, NULL },
    { &high5, &task_high5_sleep_alarm, 12, "", NULL, NULL, NULL, NULL },
    { &high6, &task_high6_sleep_alarm, 12, "", NULL, NULL, NULL, NULL },
    { &high7, &task_high7_sleep_alarm, 11, "", NULL, NULL, NULL, NULL },
    { &high8, &task_high8_sleep_alarm, 11, "", NULL, NULL, NULL, NULL },
    { &high9, &task_high9_sleep_alarm, 10, "", NULL, NULL, NULL, NULL },
    { &high10, &task_high10_sleep_alarm, 10, "", NULL, NULL, NULL, NULL },
    { &high11, &task_high11_sleep_alarm, 9, "", NULL, NULL, NULL, NULL },
    { &high12, &task_high12_sleep_alarm, 9, "", NULL, NULL, NULL, NULL },
...
ISR(ivdp1c_vint)
{
    R_OSAL_Sys_IrqHandler(412);
}

FUNC(void, OS_CODE) IVDP1C_VINT_ClearFlag(void)
{
}

ISR(ivdp1c_cint)
{
    R_OSAL_Sys_IrqHandler(413);
}

FUNC(void, OS_CODE) IVDP1C_CINT_ClearFlag(void)
{
}

ISR(ivdp1c_cmint)
{
    R_OSAL_Sys_IrqHandler(255);
}

FUNC(void, OS_CODE) IVDP1C_CMINT_ClearFlag(void)
{
}
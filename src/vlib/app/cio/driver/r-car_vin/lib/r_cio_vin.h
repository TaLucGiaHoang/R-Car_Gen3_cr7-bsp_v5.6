...
/**@defgroup group1_vin CIO VIN Driver Declaration
 * @ingroup cio_vin_driver
 *
 * @brief Bridge for the CIO server.
 *
 * Declaration of the Vin driver constant. This is the only information that needs to be exposed to the CIO server

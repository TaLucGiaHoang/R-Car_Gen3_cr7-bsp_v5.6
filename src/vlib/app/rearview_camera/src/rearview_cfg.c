 ...
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * File Name    : rearview_cfg.c
 * Version      : 1.0
 * Description  : Configuration of display and layer for rearview camera app.
 *********************************************************************************************************************/
...
static rvc_DispCfg_t loc_DispCluster =
{
    ...
    .BackgroundColor = 0xFF808080, /* grey */
};
...
#else
    {        1920,         1080,            1920,             1080,   0,    0,    2,  1920,    1080,   1920,    1920,           0,          0, 1920*1080,    450*4,    4,     false,R_VIN_VMC_INF_YUV8_BT601, R_VMC_IM_ODD_EVEN, R_ADV7482_COLOR_SPACE_OUT_YCRCB, R_ADV7482_BOUNDARY_UPTO_600MBPS, R_WM_FMT_YCBCR420,      0,    0,      0,      0,   0}, /* Settings for HDMI0 CSI40_1080P */
...
#else
    {         720,          480,             720,              480, 600,   0,    2,    720,    480,    1024,    1024,          0,          0, 1024*720,     216*1,   1,      true,R_VIN_VMC_INF_YUV8_BT601, R_VMC_IM_FULL,             0,            0, R_WM_FMT_YCBCR420,      0,    0,      0,      0,   0}, /* Settings for HDMI1 CSI20 */
    {         720,          480,             720,              480,   0,   0,    3,    720,    480,    1024,    1024,          0,          0, 1024*720,     216*1,   1,      true,R_VIN_VMC_INF_YUV8_BT601, R_VMC_IM_FULL,             0,            0, R_WM_FMT_YCBCR420,      0,    0,      0,      0,   0}, /* Settings for DPAD CSI20 */
...
rvc_Config_t rvc_DefaultConfig =
{
    .ClusterDisplayPtr   = &loc_DispCluster,
    .CidDisplayPtr       = &loc_DispCid,

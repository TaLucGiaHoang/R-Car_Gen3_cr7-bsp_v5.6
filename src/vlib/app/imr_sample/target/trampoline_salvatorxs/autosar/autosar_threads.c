 ...
 */
int64_t loc_ImrSampleThread(void*);

DeclareTask(maintask);
DeclareAlarm(maintask_sleep_alarm);
TASK(maintask) {
    loc_ImrSampleThread((void*)0);
}
...
ISR(imr_lx4_ch0)
{
    R_OSAL_Sys_IrqHandler(224);
}

FUNC(void, OS_CODE) IMR_LX4_CH0_ClearFlag(void)
{
}

ISR(imr_lx4_ch1)
{
    R_OSAL_Sys_IrqHandler(225);
}

FUNC(void, OS_CODE) IMR_LX4_CH1_ClearFlag(void)
{
}

ISR(imr_lx4_ch2)
{
    R_OSAL_Sys_IrqHandler(226);
}

FUNC(void, OS_CODE) IMR_LX4_CH2_ClearFlag(void)
{
}

ISR(imr_lx4_ch3)
{
    R_OSAL_Sys_IrqHandler(227);
}

FUNC(void, OS_CODE) IMR_LX4_CH3_ClearFlag(void)
{
}

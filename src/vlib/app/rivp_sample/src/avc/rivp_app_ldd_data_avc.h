...
#define RIVP_APP_LDD_AVC_DATA_STRM_WIDTH		(176u)						/*!< picture width  of sample stream */
#define RIVP_APP_LDD_AVC_DATA_STRM_HEIGHT		(144u)						/*!< picture height of sample stream */
#define RIVP_APP_LDD_AVC_DATA_STRM_LEVEL		(RIVP_LDD_AVC_MAX_LEVEL_10)	/*!< level of sample stream */
#define RIVP_APP_LDD_AVC_DATA_BUFFERING			(0u)

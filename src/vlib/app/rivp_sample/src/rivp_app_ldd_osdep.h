...
#define RIVP_APP_LDD_OSAL_TASK_PRIORITY		(10u)	/* priority of each task */
...
#define RIVP_APP_LDD_OSAL_SEM_NUM			(5u)
...
#define RIVP_APP_LDD_OSAL_LIB_MUTEX_ID_00 	(0x9806U)		/* OSAL_MUTEX_LDD_06 : rivp api */
#define RIVP_APP_LDD_OSAL_LIB_MUTEX_ID_01 	(0x9807U)		/* OSAL_MUTEX_LDD_07 : mng_vdp */

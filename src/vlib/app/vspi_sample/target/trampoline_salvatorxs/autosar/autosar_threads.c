...
ISR(vsp2_discom_cmpi0_ch0)
{
    R_OSAL_Sys_IrqHandler(194);
}

FUNC(void, OS_CODE) VSP2_DISCOM_CMPI0_CH0_ClearFlag(void)
{
}

ISR(vsp2_discom_cmpi0_ch1)
{
    R_OSAL_Sys_IrqHandler(195);
}

FUNC(void, OS_CODE) VSP2_DISCOM_CMPI0_CH1_ClearFlag(void)
{
}

ISR(vsp2_discom_cmpi0_ch2)
{
    R_OSAL_Sys_IrqHandler(201);
}

FUNC(void, OS_CODE) VSP2_DISCOM_CMPI0_CH2_ClearFlag(void)
{
}

ISR(vsp2_discom_cmpi0_ch3)
{
    R_OSAL_Sys_IrqHandler(202);
}

FUNC(void, OS_CODE) VSP2_DISCOM_CMPI0_CH3_ClearFlag(void)
{
}

ISR(vsp2_vspi_ch0)
{
    R_OSAL_Sys_IrqHandler(476);
}

FUNC(void, OS_CODE) VSP2_VSPI_CH0_ClearFlag(void)
{
}

ISR(vsp2_vspi_ch1)
{
    R_OSAL_Sys_IrqHandler(477);
}

FUNC(void, OS_CODE) VSP2_VSPI_CH1_ClearFlag(void)
{
}
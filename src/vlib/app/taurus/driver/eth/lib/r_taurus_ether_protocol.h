...
struct taurus_ether_init_in {
    uint64_t cookie;
    uint32_t ulStartOfDbToc;                           /* Not used */
    uint8_t  ucEthMACAddr[ETH_MACADDR_SIZE];           /* Not used */
    uint8_t  ucEthSpeed;                               /* Not used */
    uint8_t  ucEthDuplex;                              /* Not used */
    uint8_t  ucEthMagicDection;                        /* Not used */
    /* P2FUNC(void, ETH_APPL_CODE, pMagicNotification)(void);  Not Support Magic Notfication */
    uint8_t  ucEthPHYInterface;                        /* Not used */
    uint8_t  ucStartOfPayloadCrcArea;                  /* Not used */
    struct STag_Eth_QueueConfigType Eth_QueueConfig;   /* Not used */
    struct STag_Eth_ComConfigType       stComConfig;   /* Not used */
    struct STag_Eth_RxConfigType        stRxConfig;    /* Not used */
    struct STag_Eth_TxCBSType           stTxConfig;    /* Not used */
    #if (ETH_QOS_SUPPORT == STD_ON)
    struct STag_Eth_CtrlPriorityType    stEthPriority; /* Not used */
    #endif
    Eth_ClockDelayType      stClkDelayConfig;          /* Not used */
} __packed;

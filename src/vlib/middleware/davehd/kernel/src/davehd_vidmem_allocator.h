...
dhd_enum_t dhd_internal_alloc_vidmem(dhd_gpu_vidmem_heap_t *a_heap, dhd_gpu_connection_t *a_client, dhd_uint32_t a_size, dhd_uint64_t a_alignment, dhd_uint32_t a_tag, dhd_uint32_t a_usage, dhd_vidmem_t *a_result);

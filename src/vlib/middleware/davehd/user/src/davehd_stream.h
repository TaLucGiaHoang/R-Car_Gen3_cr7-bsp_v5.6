...
DHD_INLINE dhd_uint32_t dhd_checksum_get_stream_padding_size(dhd_device_data_t *a_device);
DHD_INLINE dhd_uint32_t dhd_checksum_get_padding_size(dhd_device_data_t *a_device);
...
DHD_INLINE dhd_uint32_t * dhd_stream_insert_word(dhd_device_data_t *a_device, dhd_uint32_t *a_sptr, dhd_uint32_t a_cmd);

/*----------------------------------------------------------------------------------------------------------*/

DHD_INLINE dhd_uint32_t dhd_checksum_get_stream_padding_size(dhd_device_data_t *a_device) {   /* PRQA S 3480 *//* $Misra: #INLINE_FUNCTION_DEFINED_IN_HEADER $*/ 
...
DHD_INLINE dhd_uint32_t dhd_checksum_get_padding_size(dhd_device_data_t *a_device) {   /* PRQA S 3480 *//* $Misra: #INLINE_FUNCTION_DEFINED_IN_HEADER $*/ 
#ifdef DHD_JOB_CHECKSUM_SUPPORTED
  if (a_device->m_checksum_enabled) {
    return 2;
  }
...
DHD_INLINE dhd_uint32_t * dhd_stream_insert_word(dhd_device_data_t *a_device, dhd_uint32_t *a_sptr, dhd_uint32_t a_cmd) {   /* PRQA S 3480 *//* $Misra: #INLINE_FUNCTION_DEFINED_IN_HEADER $*/ 

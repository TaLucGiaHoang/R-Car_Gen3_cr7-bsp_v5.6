...
typedef struct tagdhd_gpu_config {
  ...
  dhd_uint8_t   m_jobs_held_for_scheduling;                           /* number of jobs held for scheduling */
...
typedef union tagdhd_gpu_call_data {
  ...
  struct tagschedule_job_trigger {                                     /* dhd_gpu_schedule_job */
      dhd_gpu_device_data_t *m_device;
  } m_schedule_job_trigger;
